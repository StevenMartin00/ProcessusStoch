	...
	public void initialize() 
	{
		...
		buttonCalculerProba.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				{
					if(Double.valueOf(spinnerTempsPourcent.getValue().toString()) > 0.0)
					{
						if(Integer.valueOf(spinnerNbServeur.getValue().toString()) == 1)
						{
							results = getResult(mm1.L(), mm1.Lq(), mm1.W(), mm1.Wq(), (TimeUnit) cbUniteTemps.getSelectedItem(), true, Integer.valueOf(spinnerTempsPourcent.getValue().toString()), mm1.probaTempsSejour(Double.valueOf(spinnerTempsPourcent.getValue().toString())));
							txtAreaResultats.setText(results);
						}
						else
						{
							results = getResult(mms.L(), mms.Lq(), mms.W(), mms.Wq(), (TimeUnit) cbUniteTemps.getSelectedItem(), true, Integer.valueOf(spinnerTempsPourcent.getValue().toString()), mms.probaTempsSejour(Double.valueOf(spinnerTempsPourcent.getValue().toString())));
							txtAreaResultats.setText(results);
						}
					}
					else
